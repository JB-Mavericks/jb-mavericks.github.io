...
const Blogs = () => {
  return (
    <div className='pt-36'>
     ...
     <div className='grid grid-cols-2 xl:gap-x-20 gap-x-14 gap-y-12'>
          <div className='bg-blog rounded-2xl grid grid-cols-2 justify-center items-center xl:p-10 lg:p-8 md:p-6 p-4 xl:gap-10 lg:gap-8 md:gap-6 gap-4'>
